...
import { Trash2, Heart, Send, Image as ImageIcon, Type, Quote, X, Copy, Check, Share2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-valentine-50 py-12 px-4 relative">
      <div className="max-w-3xl mx-auto">
        <header className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-valentine-900">Create Your Story</h1>
          <p className="text-valentine-600 mt-2">Add your favorite memories and share them with your person.</p>
        </header>
            ...
            {moments.map((moment, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-4 text-valentine-400">
                  <span className="text-xs font-bold uppercase tracking-widest">Moment {index + 1}</span>
                ...
                {moment.type === "text" && (
                  <div className="space-y-4">
                    ...
                    <input 
                      ...
                      onChange={(e) => updateMoment(moment.id, { subtext: e.target.value })}
                    />
                  </div>
                )}
                ...
                {moment.type === "image" && (
                  <div className="space-y-4">
                    <input 
                      ...
                      onChange={(e) => updateMoment(moment.id, { url: e.target.value })}
                    />
                    <input 
                      placeholder="Caption"
                      className="w-full text-sm outline-none text-valentine-500"
        ...
        <div className="flex justify-center gap-4 mt-8">
          <button onClick={() => addMoment("text")} className="flex items-center gap-2 px-4 py-2 bg-white rounded-full text-sm font-semibold text-valentine-600 shadow-sm hover:shadow-md transition-all">
            <Type size={16} /> Add Text
          </button>
          <button onClick={() => addMoment("image")} className="flex items-center gap-2 px-4 py-2 bg-white rounded-full text-sm font-semibold text-valentine-600 shadow-sm hover:shadow-md transition-all">
            <ImageIcon size={16} /> Add Image
          </button>
          <button onClick={() => addMoment("quote")} className="flex items-center gap-2 px-4 py-2 bg-white rounded-full text-sm font-semibold text-valentine-600 shadow-sm hover:shadow-md transition-all">
          ...
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="text-center">
                ...
                <h2 className="text-2xl font-bold text-valentine-900 mb-2">Your Story is Ready!</h2>
                <p className="text-valentine-600 mb-6 text-sm">Copy the link below and send it to your partner.</p>
